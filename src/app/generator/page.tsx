                ...
                <div className="glass-card rounded-2xl p-5 border border-purple-500/20 bg-purple-950/20">
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch gap-2.5">
                    ...
                    <button
                      ...
                      disabled={redeeming}
                      className="px-6 py-2.5 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-semibold text-xs transition-all shadow-[0_0_20px_rgba(168,85,247,0.3)] hover:scale-[1.02] active:scale-98 whitespace-nowrap disabled:opacity-50"
                    >
